...
3.  
Возврат невозможен, т.к.в тарифе Оптимум возврат разрешён только до окончания регистрации, а клиент обратился за возвратом через 25 минут после вылета рейса.  
#
